...
const (
	...
	ANOTHER_ROUND_OR_EXIT_X            = CAPTURE_OR_CONTROL_X      // 再來一局或離開遊戲視窗的X座標
	ANOTHER_ROUND_OR_EXIT_Y            = CAPTURE_OR_CONTROL_Y      // 再來一局或離開遊戲視窗的Y座標
	ANOTHER_ROUND_OR_EXIT_WIDTH        = CAPTURE_OR_CONTROL_WIDTH  // 再來一局或離開遊戲視窗的Y座標
	ANOTHER_ROUND_OR_EXIT_HEIGHT       = CAPTURE_OR_CONTROL_HEIGHT // 再來一局或離開遊戲視窗的Y座標
	ANOTHER_ROUND_BUTTON_X             = CAPTURE_BUTTON_X          // 再來一局按鈕的X座標
	ANOTHER_ROUND_BUTTON_Y             = CAPTURE_BUTTON_Y          // 再來一局按鈕的Y座標
	ANOTHER_ROUND_BUTTON_WIDTH         = CAPTURE_BUTTON_WIDTH      // 再來一局按鈕的寬度
	ANOTHER_ROUND_BUTTON_HEIGHT        = CAPTURE_BUTTON_HEIGHT     // 再來一局按鈕的高度
	MUTINY_X                           = CAPTURE_OR_CONTROL_X      // 叛變是裝的X座標
	MUTINY_Y                           = CAPTURE_OR_CONTROL_Y      // 叛變是裝的Y座標
	MUTINY_WIDTH                       = CAPTURE_OR_CONTROL_WIDTH  // 叛變是裝的寬度
	MUTINY_HEIGHT                      = CAPTURE_OR_CONTROL_HEIGHT // 叛變是裝的高度
	MUTINY_BUTTON_X                    = CAPTURE_BUTTON_X          // 叛變按鈕的X座標
	MUTINY_BUTTON_Y                    = CAPTURE_BUTTON_Y          // 叛變按鈕的Y座標
	MUTINY_BUTTON_WIDTH                = CAPTURE_BUTTON_WIDTH      // 叛變按鈕的寬度
	MUTINY_BUTTON_HEIGHT               = CAPTURE_BUTTON_HEIGHT     // 叛變按鈕的高度
)
